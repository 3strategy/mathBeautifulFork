...
tags: [השמה לעומת הכרזה, התמצאות בקמפוס,debugging, דיבוג - קריאת שגיאות, טבלת מעקב, החלפה בין משתנים]
mathjax: true
lang: he
---
...
לפניכים סרטון הדרכה קצר המדגים כיצד ניתן להשתמש ב-Visual Studio כדי להבין ולתקן שגיאות קומפילציה בקוד.
