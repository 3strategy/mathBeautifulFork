...
כתבו תוכנית הקולטת מספר תלת־ספרתי ומחזירה האם יש בו יותר ספרות זוגיות או אי זוגיות (פירוק הספרות בעזרת אופרטורים בלבד).

- לדוגמה: במספר $$287$$ יש זוגיות: 2, 8. אי זוגיות: 7 ⟵ יותר זוגיות.

---

### 4.3.5 — קינון — מכפלת ראשוניים בתחום

קלטו שני מספרים שלמים $$a$$ ו־$$b$$  
מצאו את כל המספרים הראשוניים בתחום $$[a, b]$$ והחזירו את המכפלה של כולם.

(הפתרון מחייב קינון: לכל מספר בטווח, בדקו ראשוניות ע\"י לולאה פנימית.)
...
מצאו את המספר שבו ההפרש בין הספרה הגדולה ביותר לספרה הקטנה ביותר הוא הגבוה ביותר.
...
### 4.3.9 — גילגול — רצף של 3 מספרים זוגיים עם ממוצע מקסימלי
