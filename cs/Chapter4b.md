...
|```i--``` | כשמופיע בתוך הלולאה:	 אסור: הרחבת הלולאה במקרה חריג|
|```continue``` |	רק במקרים חריגים: דילוג על המשך גוף הלולאה עד למחזור הבא|
{: .table-en}

{: .box-warning'}
 טיפ: תבניות אלו מתקמפלות ועובדות. אף על פי כן בחלקן יש לאסור שימוש. הסיבה היא שתחביר כזה פוגע ב-code intent. בכתיבת קוד יש דברים מסויימים שהקורא מצפה להם כשהוא מסתכל על הקוד. בין היתר לתחביר סטנדרטי מפני שכך ניתן להסיק בקלות מה אמור לקרות בתוך הלולאה מבלי שיהיו הפתעות. במילים אחרות התחביר אמור לשקף עד כמה שניתן את מה שהולך לקרות ולא להסוות את מה שהולך לקרות. חלק חשוב בכתיבת קוד הוא כתיבת קוד קריא!
