# תרגול 1.3 – תרגול מתקדם: חישובים, המרות וחסכונות

בדף זה נתמקד בבעיות יומיומיות הכוללות חישובים מורכבים מעט יותר. כל התרגילים מבוססים על קלט/פלט, משתנים ופעולות חשבון בלבד.

---

### תרגיל 1: המר מ־ק"ג לגרם

כתוב תכנית שקוראת משקל בק"ג ומחשבת את המשקל בגרמים (1 ק"ג = 1000 גרם).
...
### תרגיל 2: המר מק"מ למטרים וסנטימטרים

כתוב תכנית שקוראת מרחק בק"מ ומדפיסה אותו גם במטרים וגם בסנטימטרים.
...
### תרגיל 3: חישוב זמן כולל בדקות

כתוב תכנית שקוראת שעות ודקות (למשל: 2 שעות ו־15 דקות) ומחשבת את סך הזמן בדקות.
...
### תרגיל 4: ממוצע מהירות

כתוב תכנית שקוראת מרחק בק"מ וזמן בשעות, ומדפיסה את ממוצע המהירות בקמ"ש.
...
### תרגיל 5: ממוצע ציון עם שקלול

כתוב תכנית שמחשבת ממוצע של שני ציונים, כאשר ציון אחד שווה פי 3 מהשני.
...
### תרגיל 6: חיסכון חודשי

כתוב תכנית שקוראת סכום חיסכון חודשי ומספר חודשים, ומדפיסה את הסכום הכולל שנצבר.
...
### תרגיל 7: המרת דקות לשעות ודקות

כתוב תכנית שקוראת מספר בדקות (למשל 135) ומדפיסה כמה שעות ודקות זה.
...
### תרגיל 8: חישוב עלות לאחר הנחה

כתוב תכנית שקוראת מחיר מקורי ואחוז הנחה, ומדפיסה את המחיר לאחר הנחה.
...
כתוב תכנית שקוראת מספר עמודים בספר ומספר ימים, ומחשבת כמה עמודים יש לקרוא כל יום.
