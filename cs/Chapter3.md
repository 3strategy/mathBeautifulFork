...
1. שגיאה נפוצה שראינו: בדוגמא שלהלן המילה Success תודפס תמיד מפני שיש בטעות ; בסוף התנאי. זו שגיאה (לא כל כך נפוצה) אבל מאד מטעתעת מפני שהקוד מתקמפל וקשה לשים לב לטעות. טעות כזו תתגלה בעצם רק בבדיקת מקרים. 
    ```csharp
    if (num > 5);
