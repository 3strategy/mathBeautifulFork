...
subtitle: "תרגול מתקדם בשימוש במשתנה עזר בלולאות. טבלאות מעקב"
tags: [גילגול, שמירת היסטוריה, תרגול for]
author: גיא סידס
lang: he
---
...
נסרוק כל שלשה סמוכה במערך, ונספור כמה פעמים המספר האמצעי גדול משני המספרים הסמוכים. (הסריקה היא לא קופצת בשלשות, אחרי בדיקת 42,45,40 בודקים את 45,40,80)
