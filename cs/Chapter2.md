...
![Use of unassigned variable](/assets/img/imageUnassignedVar.png)
...
## חשוב בנוסף לצפות בסרטון ההסבר על שימוש ב- breakpoints למציאת שגיאות

{: .box-success}
איתור שגיאות בקוד (דיבוג) הוא חלק בלתי נפרד מתכנות ומפיתוח חשיבה אלגוריתמית. הדרך המרכזית כיום, היא שימוש ב-breakpoint. דרך זו מתווספת לדרך ישנה ושימושית לא פחות - הדפסות ביניים.

לפניכם סרטון הדרכה קצר, המסביר כיצד מומלץ לדבג. 
