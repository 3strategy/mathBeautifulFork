...
2. **חישוב אורכי האנכים לצירים**  
   - האנך מ-A לציר ה־\(y\) הוא קו אופקי; אורכו הוא פשוט ערך ה־\(x\) של A, כלומר  
     $$
     \text{אנך ל־}y:\quad |\,t-0\,| = t\quad(\text{מאחר ש }t>0).
     $$
     {: .table-en}
   - האנך מ-A לציר ה־\(x\) הוא קו אנכי; אורכו הוא ערך ה־\(y\) של A, כלומר  
     $$
     \text{אנך ל־}x:\quad |\,f(t)-0\,| = -t^2+10t\quad(\text{מאחר }f(t)>0).
     $$
     {: .table-en}
...
3. **הגדרת פונקציית המטרה \(T\)**  
   ...
   $$
   T(t)=\underbrace{t}_{\text{אנך ל־}y}\;+\;\underbrace{(-t^2+10t)}_{\text{אנך ל־}x}
        \;=\;-x^2+11x.
   $$
