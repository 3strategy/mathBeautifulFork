...
1. **הגדרת המשתנים**: הגדירו משתנים באופן ברור, כולל יחידות מידה במידת הצורך.
2. **בניית פונקציית המטרה**: פונקציה שתתאר את הכמות שאותה אנו רוצים למקסם או למזער.
3. **מציאת תחום הגדרה**: בדקו אילו ערכים יכולים המשתנים לקבל מבחינה מציאותית.
4. **מציאת נקודות קיצון**: גזרו את פונקציית המטרה והשוו לאפס כדי למצוא נקודות קיצון.
5. **בדיקת נקודות הקיצון בתחום הנתון**: ודאו שהפתרונות אכן מתאימים לבעיה ולתחום ההגדרה.
