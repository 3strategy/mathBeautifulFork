...
<details markdown="1">
<summary>הערה למקרה שתלמידים פותחים סוגריים</summary>
...
<details markdown="1">
<summary>הרחבה לגבי הזזה אם יש זמן</summary>
...
א. $$ f(x) = (x+1)(x-3) $$ 
<details markdown="1">
<summary>אז למה נחש?</summary>
זו פרבולה מחייכת אבל הנחש יותר "חזק"
</details>
...
1. $$f(x)=(x−2)(x−4)(x−6)$$
1. $$f(x)=(x−2)(4-x)(x−6)$$ 
  היפוך הסדר בין המספרים - למה זה שקול?.
1. $$f(x)=x^3(x−2)$$
