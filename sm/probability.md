...
* **חיתוך מאורעות $$(A \cap B)$$** – המאורע שבו התוצאה משותפת גם ל-A וגם ל-B.
    **↳ כופלים בין הסתברויות.**
    <details mathjax="a"><summary>דוגמא והרחבה</summary>
    * בדרך כלל (נדייק זאת בהמשך) ההסתברות $$P(A \cap B) = P(A)\cdot P(B)$$. כך למשל, הסיכוי להוציא 3 בקוביה הוא  $$\frac{1}{6}$$ והסיכוי להוציא פעמיים רצוף 3 הוא $$\frac{1}{6}\cdot\frac{1}{6} \\ P(A \cap B) = P(A)\cdot P(B)\;\overset{\text{אמ״מ}}{\iff}\;\text{בלתי תלויים B -ו A}$$ נעמיק במושג "בלתי תלויים" בהמשך
    </details>
...
* **מאורעות זרים** – מאורעות שאין להם תוצאות משותפות $$(A \cap B)=\varnothing$$, ולכן  
    ...
    P(A \cap B) = 0
    $$
    <details mathjax="a"><summary>דוגמא</summary>
    * **דוגמה – מאורעות זרים**:  
