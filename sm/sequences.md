...
$$
a_1,\;\dots,\;a_n,\;
\underbrace{a_{n+1}}_{\substack{\text{האיבר}\\\text{האמצעי}}},
\underbrace{a_{n+2}}_{\substack{\text{הראשון מבין}\\\text{האחרונים}}},
\dots,a_{2n+1}
$$
</small>
...
**כלל נסיגה לדוגמא: לא במיקוד*** 
$$F_n = F_{n-1} + F_{n-2},\, n>2$$   בתנאי התחלה $$a_1=1, a_2=1$$ זו סדרת פיבונאצ'י.
