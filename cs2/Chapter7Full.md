...
- **חתימת הפונקציה:** כוללת רק את **שם הפונקציה והחלק בו מוגדרים הפרמטרים בסדר מסויים.** בכל מקרה של שתי פונקציות עם אותו שם - יהיה בהכרח הבדל בחתימה (ולכן בפרמטרים שהן מקבלות).
