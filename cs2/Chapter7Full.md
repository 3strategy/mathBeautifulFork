...
נבחן כעת פתרונות לשימוש חוזר בקוד **בלי, ועם פונקציה**. נניח שנרצה להדפיס שלוש שורות של כוכביות (בכל שורה 10 כוכביות). נשווה בין שני מימושים: **בלי פונקציה - תוך חזרת קוד,** ועם פונקציה.
...
**נגדיר פונקציה סטטית שמדפיסה שורה של כוכביות.** הפונקציה לא מקבלת שום פרמטר (הסוגריים ריקים) ולא מחזירה ערך, **ולכן סוג הערך המוחזר מוגדר כ-void**. 
